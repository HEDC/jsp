...
byte b4[]=ware.getBytes("ISO-8859-1");
ware=new String(b4,"UTF-8");

Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance(); 
String connectSQL="jdbc:sqlserver://localhost:1433;DatabaseName=学生档案";
Connection conn=java.sql.DriverManager.getConnection(connectSQL,"sa","");
Statement stmt=conn.createStatement();
ResultSet rs= stmt.executeQuery("select * from dangan");
out.println("<table>");
while(rs.next()){
	out.println("<tr>");
	...
	out.println("<td>"+rs.getString("ware")+("</td>"));
}
out.println("</table>");
%>
<% 
String sql="insert into dangan values (?,?,?,?)";
